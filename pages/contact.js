...
export default function Contact () {
    ...
    <>
        <Head>
            <title>Soft Land | Contact Us</title>
                ...
                <div className="swiper-slide">
                  <div className="review text-center">
                    <p className="stars">
                      ...
                      <span className="bi bi-star-fill" />
                      <span className="bi bi-star-fill" />
                      <span className="bi bi-star-fill muted" />
                    </p>
                    <h3>Excellent App!</h3>
                    <blockquote>
                      <p>
                ...
                <div className="swiper-slide">
                  <div className="review text-center">
                    ...
                    <p className="review-user">
                      ...
                      />
                      <span className="d-block">
                        <span className="text-black">Johan Smith</span>, — App
                        User
                      </span>
                    </p>
                  </div>
                ...
                <div className="swiper-slide">
                  <div className="review text-center">
                    ...
                    <p className="review-user">
                      ...
                      />
                      <span className="d-block">
                        <span className="text-black">Jean Thunberg</span>, — App
                        User
                      </span>
                    </p>
                  </div>
